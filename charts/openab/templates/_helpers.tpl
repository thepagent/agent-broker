...
{{- if .Values.agent.preset }}
  ...
  {{- else if eq .Values.agent.preset "copilot" }}ghcr.io/openabdev/openab-copilot
...
{{- if .Values.agent.preset }}
  ...
  {{- else if eq .Values.agent.preset "copilot" }}copilot
...
{{- if .Values.agent.preset }}
  ...
  {{- else if eq .Values.agent.preset "copilot" }}["--acp", "--stdio"]
